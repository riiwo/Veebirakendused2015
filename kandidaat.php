...
<div class="container">
    <form action="POST">
        <p>Eesnimi <input type="text" name="candidate_number"/></p>
        <p>Perenimi <input type="text" name="candidate_number" /></p>
        <p>Kandidaadi number <input type="text" name="candidate_number" /></p>
        <p>Lisa pilt    <input type="file" name="fileupload" accept="image/*" /></p>
        <p>Sünniaeg ja -koht <input type="text" name="candidate_number" /></p>
        <p>Perekonnaseis <input type="text" name="candidate_number" /></p>
        <p>Haridus <input type="text" name="candidate_number" /></p>
        <p>Ametid <input type="text" name="candidate_number" /></p>
        <p>Erakond <select name="party">
        ...
        <p>Piirkond <select type="region" name="candidate_number">
            <option value="#" selected></option>
        ...
        <p>E-post <input type="text" name="candidate_number" /></p>
        <p>Facebook <input type="text" name="candidate_number" /></p>
        <p>Telefon <input type="text" name="candidate_number" /></p>
        <p>Erakond <input type="text" name="candidate_number" /></p>
        <p>Valimisringkond <input type="text" name="candidate_number" /></p>
        <p>Töökohad <input type="text" name="candidate_number" /></p>
        <p>Esinduskogud <input type="text" name="candidate_number" /></p>
        <p>Keeled <input type="text" name="candidate_number" /></p>
